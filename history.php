...
if (isset($_POST['cancel'])) {
  ...
  $updateStatus = mysqli_query($conn, "UPDATE pembayaran SET status='Dibatalkan' WHERE id_pembayaran=$idPembayaran");

  if ($updateStatus) {
    header('location: history.php');
  } else {
    echo '<script>alert("Pembatalan Gagal"); window.location.href="history.php";</script>';
  }
}
?>
    ...
    <section id="horizontal-pricing" class="horizontal-pricing pt-0">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 pricing-item" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-3 d-flex align-items-center justify-content-center">
            <div id="cancel" class="text-center"><a href="historynew.php" class="buy-btn" name="cancel" onclick="cancelBooking(7)">Re-fund</a></div>
          </div>
