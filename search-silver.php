...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM search-silver WHERE city = 'Jakarta' AND package = 'Silver' AND availability = 'available'";
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 " data-aos="fade-up" data-aos-delay="100">
            <div class="pricing-item">
              ...
              <a href="preview-silver.php" class="buy-btn">See More</a>
            </div>
